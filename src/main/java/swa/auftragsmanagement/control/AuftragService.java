...
public class AuftragService {
    ...
    {
        System.out.println("orderId: " + orderAccepted.getOrderId() + " and " + orderAccepted.getShipURL());

        Auftrag auftrag = auftragManagement.getAuftragByID(orderAccepted.getOrderId());

        if (auftrag != null)
        {
            auftrag.setUrl(orderAccepted.getShipURL());
        }
    }
}
